    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-4 py-8 sm:px-6">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-foreground-muted">Connect Gmail with read-only permission, then analyze your recent inbox messages on demand.</p>
        </div>
        ...
        <section className="rounded-2xl border border-border bg-surface p-5 sm:p-6">
          ...
          {loadState === "ready" && status?.connected && <>
            ...
            <p className="mt-5 text-xs text-foreground-subtle">SafeCheck requests Gmail read-only access. It never sends, deletes, or modifies messages.</p>
          </>}
